...
public class Scene_Description : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        text_Monster.text = Description.Elfin(Scene_Welcome.languageChosen);
        //</toggleGroup_Monster>
        ...
        text_Perk.text = Description.MachineMastery(Scene_Welcome.languageChosen);
    }
    ...
    {
        if (toggle_Elfin.isOn) text_Monster.text = Description.Elfin(Scene_Welcome.languageChosen);
        if (toggle_Crawler.isOn) text_Monster.text = Description.Crawler(Scene_Welcome.languageChosen);
        if (toggle_Zombie.isOn) text_Monster.text = Description.Zombie(Scene_Welcome.languageChosen);
        if (toggle_Thirsty.isOn) text_Monster.text = Description.Thirsty(Scene_Welcome.languageChosen);
        if (toggle_Butcher.isOn) text_Monster.text = Description.Butcher(Scene_Welcome.languageChosen);
        if (toggle_Unicorn.isOn) text_Monster.text = Description.Unicron(Scene_Welcome.languageChosen);
        if (toggle_Desolator.isOn) text_Monster.text = Description.Desolator(Scene_Welcome.languageChosen);
        if (toggle_Manmoth.isOn) text_Monster.text = Description.Manmoth(Scene_Welcome.languageChosen);
        if (toggle_Tank.isOn) text_Monster.text = Description.Tank(Scene_Welcome.languageChosen);
        if (toggle_Dragon.isOn) text_Monster.text = Description.Dragon(Scene_Welcome.languageChosen);
    }

    public void OnClick_AnyTurrent()
    {
        if (toggle_MachineGun.isOn) text_Tower.text = Description.MachineGun(Scene_Welcome.languageChosen);
        if (toggle_CrossbowHunter.isOn) text_Tower.text = Description.CrossbowHunter(Scene_Welcome.languageChosen);
        if (toggle_Sniper.isOn) text_Tower.text = Description.Sniper(Scene_Welcome.languageChosen);
        if (toggle_PillBox.isOn) text_Tower.text = Description.PillBox(Scene_Welcome.languageChosen);
        if (toggle_SharpnelThrower.isOn) text_Tower.text = Description.SharpnelThrower(Scene_Welcome.languageChosen);
        if (toggle_PatriotMissile.isOn) text_Tower.text = Description.PatriotMissile(Scene_Welcome.languageChosen);
    ...
    {
        if (toggle_MM.isOn) text_Perk.text = Description.MachineMastery(Scene_Welcome.languageChosen);
        if (toggle_MB.isOn) text_Perk.text = Description.MadBomber(Scene_Welcome.languageChosen);
        if (toggle_FR.isOn) text_Perk.text = Description.FireRanger(Scene_Welcome.languageChosen);
        if (toggle_TS.isOn) text_Perk.text = Description.ThunderSpirit(Scene_Welcome.languageChosen);
    }
}
